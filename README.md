# Building Registry [![Build Status](https://github.com/Informatievlaanderen/building-registry/workflows/Build/badge.svg)](https://github.com/Informatievlaanderen/building-registry/actions)

## Goal

> Authentic base registry containing all buildings of Flanders.
...
We use Structurizr to generate our documentation and populate our architecture decisions. All of this can be found in the [Structurizr](https://github.com/Informatievlaanderen/building-registry/tree/master/docs/BuildingRegistry.Structurizr) console application.

To run it, make sure you have an `appsettings.json` with a structurizr.com `WorkspaceId`, `ApiKey` and `ApiSecret`. If you have moved your [adr's](https://github.com/Informatievlaanderen/building-registry/tree/master/docs/adr) to another location, don't forget to update `AdrPath`.
...
* [AWS SDK for .NET](https://github.com/aws/aws-sdk-net) - _The AWS SDK for .NET enables .NET developers to easily work with Amazon Web Services and build scalable solutions with Amazon S3, Amazon DynamoDB, Amazon Glacier, and more._ - [Apache License 2.0](https://choosealicense.com/licenses/apache-2.0/)
