...
Target.create "Containerize_ProjectionsRedis" (fun _ -> containerize "BuildingRegistry.Projections.LastChangedList" "projections-redis")
Target.create "PushContainer_ProjectionsRedis" (fun _ -> push "projections-redis")
