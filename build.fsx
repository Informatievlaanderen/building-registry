...
let dockerRepository = "buildingregistry"
...
Target "Restore_Solution" (fun _ -> restore "BuildingRegistry")

Target "Build_Solution" (fun _ -> build "BuildingRegistry")

Target "Test_Solution" (fun _ -> test "BuildingRegistry")
...
Target "Containerize_Projector" (fun _ -> containerize "BuildingRegistry.Projector" "projections")
Target "PushContainer_Projector" (fun _ -> push "projections")

Target "Containerize_ApiLegacy" (fun _ -> containerize "BuildingRegistry.Api.Legacy" "api-legacy")
Target "PushContainer_ApiLegacy" (fun _ -> push "api-legacy")

Target "Containerize_ApiExtract" (fun _ -> containerize "BuildingRegistry.Api.Extract" "api-extract")
Target "PushContainer_ApiExtract" (fun _ -> push "api-extract")

Target "Containerize_ApiCrabImport" (fun _ -> containerize "BuildingRegistry.Api.CrabImport" "api-crab-import")
Target "PushContainer_ApiCrabImport" (fun _ -> push "api-crab-import")

Target "Containerize_ProjectionsLegacy" (fun _ -> containerize "BuildingRegistry.Projections.Legacy" "projections-legacy")
Target "PushContainer_ProjectionsLegacy" (fun _ -> push "projections-legacy")

Target "Containerize_ProjectionsExtract" (fun _ -> containerize "BuildingRegistry.Projections.Extract" "projections-extract")
Target "PushContainer_ProjectionsExtract" (fun _ -> push "projections-extract")

Target "Containerize_ProjectionsRedis" (fun _ -> containerize "BuildingRegistry.Projections.LastChangedList" "projections-redis")
Target "PushContainer_ProjectionsRedis" (fun _ -> push "projections-redis")

Target "Containerize_ProjectionsSyndication" (fun _ -> containerize "BuildingRegistry.Projections.Syndication" "projections-syndication")
