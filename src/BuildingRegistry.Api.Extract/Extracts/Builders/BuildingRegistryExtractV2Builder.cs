namespace BuildingRegistry.Api.Extract.Extracts.Builders
{
    ...
    public static class BuildingRegistryExtractV2Builder
    {
        public static IEnumerable<ExtractFile> CreateBuildingFiles(ExtractContext context)
        {
            ...
            var buildingProjectionState = context
                .ProjectionStates
                .AsNoTracking()
                .Single(m => m.Name == typeof(BuildingExtractV2Projections).FullName);
            ...
            yield return ExtractBuilder.CreateDbfFile<BuildingExtractItemV2, BuildingDbaseRecord>(
