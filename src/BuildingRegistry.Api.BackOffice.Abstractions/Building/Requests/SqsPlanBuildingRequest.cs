namespace BuildingRegistry.Api.BackOffice.Abstractions.Building.Requests
{
    ...
    public class SqsPlanBuildingRequestExamples : IExamplesProvider<SqsPlanBuildingRequest>
    {
        public SqsPlanBuildingRequest GetExamples()
        {
            return new SqsPlanBuildingRequest
            {
