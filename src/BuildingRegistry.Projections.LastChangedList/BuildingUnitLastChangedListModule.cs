namespace BuildingRegistry.Projections.LastChangedList
{
    ...
    public class BuildingUnitLastChangedListModule : LastChangedListModule
    {
        public BuildingUnitLastChangedListModule(
        ...
        {
            var logger = loggerFactory.CreateLogger<BuildingUnitLastChangedListModule>();
