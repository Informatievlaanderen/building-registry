namespace BuildingRegistry.Projections.LastChangedList
{
    ...
    public class BuildingProjectionsV3 : LastChangedListConnectedProjection
    {
        public const string ProjectionName = "Cache markering gebouwen (v3)";
        private static readonly AcceptType[] SupportedAcceptTypes = [AcceptType.JsonLd];

        public BuildingProjectionsV3(ICacheValidator cacheValidator)
        ...
        protected override string BuildCacheKey(AcceptType acceptType, string identifier)
        {
            ...
            {
                AcceptType.JsonLd => $"oslo-v3/building:{identifier}.{shortenedAcceptType}",
        ...
        protected override string BuildUri(AcceptType acceptType, string identifier)
        {
            return acceptType switch
            {
                AcceptType.JsonLd => $"/v3/gebouwen/{identifier}",
