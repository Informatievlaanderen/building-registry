namespace BuildingRegistry.Api.BackOffice.Handlers.BuildingUnit
{
    ...
    public class CorrectBuildingUnitRetirementHandler : BuildingUnitBusHandler, IRequestHandler<CorrectBuildingUnitRetirementRequest, ETagResponse>
    {
        private readonly IdempotencyContext _idempotencyContext;

        public CorrectBuildingUnitRetirementHandler(
        ...
        public async Task<ETagResponse> Handle(CorrectBuildingUnitRetirementRequest request, CancellationToken cancellationToken)
        {
