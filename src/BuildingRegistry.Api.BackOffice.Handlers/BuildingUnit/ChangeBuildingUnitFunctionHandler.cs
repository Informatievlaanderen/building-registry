namespace BuildingRegistry.Api.BackOffice.Handlers.BuildingUnit
{
    ...
    public class ChangeBuildingUnitFunctionHandler : BuildingUnitBusHandler, IRequestHandler<ChangeBuildingUnitFunctionRequest, ETagResponse>
    {
        private readonly IdempotencyContext _idempotencyContext;

        public ChangeBuildingUnitFunctionHandler(
        ...
        public async Task<ETagResponse> Handle(ChangeBuildingUnitFunctionRequest request, CancellationToken cancellationToken)
        {
