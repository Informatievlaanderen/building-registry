namespace BuildingRegistry.Api.BackOffice.Handlers.Sqs.Lambda.Handlers.BuildingUnit
{
    ...
    public abstract class SqsLambdaBuildingUnitHandler<TSqsLambdaRequest> : IRequestHandler<TSqsLambdaRequest>
        where TSqsLambdaRequest : SqsLambdaBuildingUnitRequest
    {
        ...
        protected SqsLambdaBuildingUnitHandler(
