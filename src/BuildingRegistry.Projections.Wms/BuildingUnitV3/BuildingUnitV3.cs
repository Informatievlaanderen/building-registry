namespace BuildingRegistry.Projections.Wms.BuildingUnitV3
{
    ...
    public class BuildingUnitConfiguration : IEntityTypeConfiguration<BuildingUnitV3>
    {
        public const string TableName = "BuildingUnitsV3";

        public void Configure(EntityTypeBuilder<BuildingUnitV3> b)
        {
            ...
            b.Property(BuildingUnitV3.VersionTimestampBackingPropertyName)
