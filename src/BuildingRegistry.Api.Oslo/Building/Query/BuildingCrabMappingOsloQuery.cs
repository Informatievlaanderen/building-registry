namespace BuildingRegistry.Api.Oslo.Building.Query
{
    ...
    public class BuildingCrabMappingOsloQuery : Query<BuildingPersistentLocalIdCrabIdMapping, BuildingCrabMappingFilter>
    {
        private readonly LegacyContext _context;

        protected override ISorting Sorting => new BuildingCrabMappingSorting();

        public BuildingCrabMappingOsloQuery(LegacyContext context)
        {
            _context = context;
        }
