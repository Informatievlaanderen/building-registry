namespace BuildingRegistry.Api.Oslo.Building.V2.List
{
    using System;
    ...
    public class BuildingListResponseOsloExamples : IExamplesProvider<BuildingListOsloResponse>
    {
        ...
        public BuildingListResponseOsloExamples(IOptions<ResponseOptionsV2> responseOptionsProvider) => _responseOptions = responseOptionsProvider.Value;
