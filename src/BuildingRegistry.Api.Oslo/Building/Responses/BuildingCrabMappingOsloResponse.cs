namespace BuildingRegistry.Api.Oslo.Building.Responses
{
    ...
    public class BuildingCrabMappingOsloResponse
    {
        /// <summary>
    ...
    public class BuildingCrabMappingOsloResponseExamples : IExamplesProvider<BuildingCrabMappingOsloResponse>
    {
        public BuildingCrabMappingOsloResponse GetExamples()
            => new BuildingCrabMappingOsloResponse
            {
