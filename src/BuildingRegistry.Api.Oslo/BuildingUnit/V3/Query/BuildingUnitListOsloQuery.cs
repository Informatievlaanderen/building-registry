namespace BuildingRegistry.Api.Oslo.BuildingUnit.V3.Query
{
    using System;
    ...
    public class BuildingUnitListOsloQuery : Query<BuildingUnitQueryItem, BuildingUnitFilter>
    {
        private readonly LegacyContext _context;

        protected override ISorting Sorting => new BuildingUnitSorting();

        public BuildingUnitListOsloQuery(LegacyContext context)
        {
            _context = context;
        }
