namespace BuildingRegistry.Api.Oslo.BuildingUnit.V2.List
{
    using System;
    ...
    public class BuildingUnitListOsloResponseExamples : IExamplesProvider<BuildingUnitListOsloResponse>
    {
        ...
        public BuildingUnitListOsloResponseExamples(IOptions<ResponseOptionsV2> responseOptionsProvider) => _responseOptions = responseOptionsProvider.Value;
