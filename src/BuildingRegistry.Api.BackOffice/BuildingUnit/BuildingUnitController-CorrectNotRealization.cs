namespace BuildingRegistry.Api.BackOffice.BuildingUnit
{
    ...
    public partial class BuildingUnitController
    {
        ...
        /// <param name="ct"></param>
        /// <returns></returns>
        [HttpPost("{buildingUnitPersistentLocalId}/acties/corrigeren/nietrealisering")]
        [ProducesResponseType(StatusCodes.Status202Accepted)]
        [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status500InternalServerError)]
        [SwaggerResponseHeader(StatusCodes.Status202Accepted, "location", JsonSchemaType.String, "De url van de gebouweenheid.")]
        ...
        public async Task<IActionResult> CorrectNotRealization(
            ...
            [FromRoute] CorrectBuildingUnitNotRealizationRequest request,
