namespace BuildingRegistry.Building.Commands
{
    ...
    public sealed class DetachAddressFromBuildingUnitBecauseAddressWasRetired : IHasCommandProvenance
    {
        private static readonly Guid Namespace = new Guid("53096dca-6c71-43db-a51b-b63bbde07cc1");
        ...
        public DetachAddressFromBuildingUnitBecauseAddressWasRetired(
        ...
        public Guid CreateCommandId()
            => Deterministic.Create(Namespace, $"DetachAddressFromBuildingUnitBecauseAddressWasRetired-{ToString()}");
