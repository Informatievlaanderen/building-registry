namespace BuildingRegistry.Building.Commands
{
    ...
    public sealed class CorrectBuildingUnitRemoval : IHasCommandProvenance
    {
        private static readonly Guid Namespace = new Guid("16c47d7a-5e90-4b16-a994-9dea2f258c5e");
        ...
        public CorrectBuildingUnitRemoval(
        ...
        public Guid CreateCommandId()
            => Deterministic.Create(Namespace, $"CorrectBuildingUnitRemoval-{ToString()}");
