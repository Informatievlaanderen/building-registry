namespace BuildingRegistry.Building.Commands
{
    ...
    public sealed class RegularizeBuildingUnit : IHasCommandProvenance
    {
        private static readonly Guid Namespace = new Guid("d26e4b94-ed57-4347-abbb-44eba63d83f4");
        ...
        public Guid CreateCommandId()
            => Deterministic.Create(Namespace, $"RegularizeBuildingUnit-{ToString()}");
