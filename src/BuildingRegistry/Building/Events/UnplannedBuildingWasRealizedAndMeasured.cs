namespace BuildingRegistry.Building.Events
{
    ...
    [EventName(EventName)]
    [EventDescription("Het gebouw werd vastgesteld.")]
    public sealed class UnplannedBuildingWasRealizedAndMeasured : IBuildingEvent
    {
        public const string EventName = "UnplannedBuildingWasRealizedAndMeasured"; // BE CAREFUL CHANGING THIS!!
        ...
        [JsonConstructor]
        private UnplannedBuildingWasRealizedAndMeasured(
