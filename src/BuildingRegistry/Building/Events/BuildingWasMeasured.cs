namespace BuildingRegistry.Building.Events
{
    ...
    [EventName(EventName)]
    [EventDescription("Het gebouw werd ingemeten.")]
    public sealed class BuildingWasMeasured : IBuildingEvent
    {
        public const string EventName = "BuildingWasMeasured"; // BE CAREFUL CHANGING THIS!!
