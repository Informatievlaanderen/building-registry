            ...
            string backofficeProjectionsConnectionString)
        {
            services
                ...
                .AddDbContext<IntegrationContext>((provider, options) => options
                    ...
                    .UseNpgsql(provider.GetRequiredService<TraceDbConnection<IntegrationContext>>(), npgsqlDbContextOptionsBuilder =>
                    {
                        npgsqlDbContextOptionsBuilder.EnableRetryOnFailure();
                        npgsqlDbContextOptionsBuilder.MigrationsHistoryTable(MigrationTables.Integration, Schema.Integration);
