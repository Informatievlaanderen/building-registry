...
namespace BuildingRegistry.Projections.Integration.Migrations
{
    ...
    [Migration("20240819114349_AddBuildingId_PositionIndex")]
    partial class AddBuildingId_PositionIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BuildingRegistry.Projections.Integration.Building.Version.BuildingVersion", b =>
                {
                    ...
                    b.HasIndex("BuildingId", "Position");

                    b.HasIndex("BuildingPersistentLocalId", "Position");

                    b.ToTable("building_versions", "integration_building");
                });

            modelBuilder.Entity("BuildingRegistry.Projections.Integration.Building.VersionFromMigration.BuildingUnitAddressVersion", b =>
                {
                    b.Property<long>("Position")
                        .HasColumnType("bigint")
                        .HasColumnName("position");
                    ...
                    b.ToTable("building_unit_address_versions_migration", "integration_building");
                });

            modelBuilder.Entity("BuildingRegistry.Projections.Integration.Building.VersionFromMigration.BuildingUnitVersion", b =>
                {
                    b.Property<long>("Position")
                        .HasColumnType("bigint")
                        .HasColumnName("position");
                    ...
                    b.ToTable("building_unit_versions_migration", "integration_building");
                });

            modelBuilder.Entity("BuildingRegistry.Projections.Integration.Building.VersionFromMigration.BuildingVersion", b =>
                {
                    b.Property<long>("Position")
                        .HasColumnType("bigint")
                        .HasColumnName("position");
                    ...
                    b.ToTable("building_versions_migration", "integration_building");
                });
            ...
            modelBuilder.Entity("BuildingRegistry.Projections.Integration.Building.VersionFromMigration.BuildingUnitAddressVersion", b =>
                {
                    b.HasOne("BuildingRegistry.Projections.Integration.Building.VersionFromMigration.BuildingUnitVersion", null)
                        .WithMany("Addresses")
                        .HasForeignKey("Position", "BuildingUnitPersistentLocalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BuildingRegistry.Projections.Integration.Building.VersionFromMigration.BuildingUnitVersion", b =>
                {
                    b.HasOne("BuildingRegistry.Projections.Integration.Building.VersionFromMigration.BuildingVersion", null)
                        .WithMany("BuildingUnits")
                        .HasForeignKey("Position")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
