namespace BuildingRegistry.Api.BackOffice.Handlers.Lambda.Handlers.BuildingUnit
{
    ...
    public sealed class NotRealizeBuildingUnitLambdaHandler : BuildingUnitLambdaHandler<NotRealizeBuildingUnitLambdaRequest>
    {
        ...
        protected override async Task<object> InnerHandle(NotRealizeBuildingUnitLambdaRequest request, CancellationToken cancellationToken)
        {
        ...
        protected override TicketError? InnerMapDomainException(DomainException exception, NotRealizeBuildingUnitLambdaRequest request)
        {
            return exception switch
            {
                BuildingUnitHasInvalidFunctionException => ValidationErrors.Common.CommonBuildingUnit.InvalidFunction.ToTicketError(),
                BuildingUnitHasInvalidStatusException => ValidationErrors.NotRealizeBuildingUnit.BuildingUnitInvalidStatus.ToTicketError(),
                _ => null
            };
        }
    }
