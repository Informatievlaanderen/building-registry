namespace BuildingRegistry.Api.BackOffice.Handlers.Lambda.Handlers.Building
{
    ...
    public sealed class PlaceBuildingUnderConstructionLambdaHandler : BuildingLambdaHandler<PlaceBuildingUnderConstructionLambdaRequest>
    {
        ...
        protected override async Task<object> InnerHandle(PlaceBuildingUnderConstructionLambdaRequest request, CancellationToken cancellationToken)
        {
        ...
        protected override TicketError? InnerMapDomainException(DomainException exception, PlaceBuildingUnderConstructionLambdaRequest request)
        {
            return exception switch
            {
                BuildingHasInvalidStatusException => ValidationErrors.PlaceBuildingUnderConstruction.BuildingInvalidStatus.ToTicketError(),
                _ => null
            };
        }
    }
