namespace BuildingRegistry.Projections.Wfs.BuildingV4
{
    ...
    public class BuildingConfiguration : IEntityTypeConfiguration<BuildingV4>
    {
        public const string TableName = "BuildingsV4";

        public void Configure(EntityTypeBuilder<BuildingV4> b)
        {
            ...
            b.Property(BuildingV4.VersionTimestampBackingPropertyName)
