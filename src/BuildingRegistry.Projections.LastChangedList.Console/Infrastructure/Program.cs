namespace BuildingRegistry.Projections.LastChangedList.Console.Infrastructure
{
    ...
    public class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            Log.Information("Initializing BuildingRegistry.Projections.LastChangedList.Console");
            ...
            var host = new HostBuilder()
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    healthChecksBuilder.AddDbContextCheck<LastChangedListContext>(
                ...
                .ConfigureContainer<ContainerBuilder>((hostContext, builder) =>
                {
                    ...
                    builder.RegisterModule(new LastChangedListConsoleModule(hostContext.Configuration, services, loggerFactory));

                    builder
                        .RegisterType<ProjectionRunner>()
                        .As<IHostedService>()
                        .SingleInstance();
            ...
            Log.Information("Starting BuildingRegistry.Projections.LastChangedList.Console");
