namespace BuildingRegistry.Projections.LastChangedList.Console.Infrastructure
{
    ...
    public sealed class LastChangedListBuildingCacheValidator : ICacheValidator
    {
        private readonly string _connectionString;
        private readonly string _projectionName;

        public LastChangedListBuildingCacheValidator(string connectionString, string projectionName)
        {
