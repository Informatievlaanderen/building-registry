    ...
    public sealed class ProjectionsHandlesEventsTests
    {
        ...
        public static IEnumerable<object[]> GetProjectionsToTest()
        {
            ...
            yield return [new List<ConnectedProjection<IntegrationContext>>
            {
                ...
                new Projections.Integration.Building.VersionFromMigration.BuildingVersionProjections(Mock.Of<IOptions<IntegrationOptions>>())
            }];
            ...
            {
                new BuildingRegistry.Producer.Ldes.ProducerBuildingProjections(Mock.Of<IProducer>(), "", new JsonSerializerSettings()),
