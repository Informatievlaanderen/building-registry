namespace BuildingRegistry.Tests.Autofixture
{
    ...
    {
        public static IGeometry ValidPolygon =>
            new WKTReader().Read(
        ...
        public static IGeometry ValidPolygonWithNoValidPoints =>
            new WKTReader().Read(
                "POLYGON ((30 10, 10 20, 20 40, 40 40, 30 10))");

        public static IGeometry ValidPointInPolygon =>
            new WKTReader().Read("POINT (141299 185188)");

        public static IGeometry OtherValidPointInPolygon =>
            new WKTReader().Read("POINT (141298 185187)");

        public static IGeometry PointNotInPolygon =>
