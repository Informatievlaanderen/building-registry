namespace BuildingRegistry.Tests.BackOffice.Api.BuildingUnit.WhenDeregulatingBuildingUnit
{
    using System;
    ...
    public class GivenSqsToggleEnabled : BackOfficeApiTest
    {
        ...
        public async Task ThenTicketLocationIsReturned()
        {
            ...
            var request = Fixture.Create<DeregulateBuildingUnitRequest>();
            ...
            MockMediator.Verify(x =>
                x.Send(
                    It.Is<DeregulateBuildingUnitSqsRequest>(sqsRequest =>
        ...
        public async Task WithInvalidIfMatchHeader_ThenPreconditionFailedResponse()
        {
            ...
            var result = await _controller.Deregulate(
                ...
                Fixture.Create<DeregulateBuildingUnitRequest>(),
        ...
        public void WhenAggregateNotFoundException_ThenThrowApiException()
        {
            ...
            MockMediator
                .Setup(x => x.Send(It.IsAny<DeregulateBuildingUnitSqsRequest>(), CancellationToken.None).Result)
