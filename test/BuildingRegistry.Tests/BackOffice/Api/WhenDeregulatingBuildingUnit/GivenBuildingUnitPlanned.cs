namespace BuildingRegistry.Tests.BackOffice.Api.WhenDeregulatingBuildingUnit
{
    ...
    public class GivenBuildingUnitPlanned : BackOfficeApiTest
    {
        ...
        public async Task WithInvalidIfMatchHeader_ThenReturnsPreconditionFailedResponse()
        {
            ...
            //Act
            var result = (PreconditionFailedResult)await _controller.Deregulate(
                ResponseOptions,
            ...
            //Assert
            MockMediator.Verify(x => x.Send(It.IsAny<DeregulateBuildingUnitRequest>(), CancellationToken.None), Times.Never);
