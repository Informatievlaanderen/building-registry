namespace BuildingRegistry.Tests.BackOffice.Api.Building.WhenRemovingBuilding
{
    using System;
    ...
    public class GivenBuildingNotFound : BackOfficeApiTest
    {
        ...
        public async Task ThenTicketLocationIsReturned()
        {
            ...
            var request = Fixture.Create<RemoveBuildingRequest>();
            ...
            MockMediator.Verify(x =>
                x.Send(
                    It.Is<RemoveBuildingSqsRequest>(sqsRequest =>
