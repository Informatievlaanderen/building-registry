namespace BuildingRegistry.Tests.BackOffice.Api.Building.WhenCorrectingBuildingRealization
{
    using System;
    ...
    public class GivenSqsToggleEnabled : BackOfficeApiTest
    {
        ...
        public async Task ThenTicketLocationIsReturned()
        {
            ...
            var request = Fixture.Create<CorrectBuildingRealizationRequest>();
            ...
            MockMediator.Verify(x =>
                x.Send(
                    It.Is<CorrectBuildingRealizationSqsRequest>(sqsRequest =>
