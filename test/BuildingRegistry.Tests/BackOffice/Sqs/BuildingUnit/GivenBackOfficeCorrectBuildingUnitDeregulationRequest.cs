namespace BuildingRegistry.Tests.BackOffice.Sqs.BuildingUnit
{
    ...
    public sealed class GivenBackOfficeCorrectBuildingUnitDeregulationRequest : BuildingRegistryTest
    {
        private readonly FakeBackOfficeContext _backOfficeContext;

        public GivenBackOfficeCorrectBuildingUnitDeregulationRequest(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        ...
        public async Task ThenTicketWithLocationIsCreated()
        {
            ...
            var sut = new CorrectBuildingUnitDeregulationSqsHandler(
                sqsQueue.Object,
                ticketingMock.Object,
                ticketingUrl,
                _backOfficeContext);

            var sqsRequest = new CorrectBuildingUnitDeregulationSqsRequest()
            {
                Request = new CorrectBuildingUnitDeregulationRequest()
                {
