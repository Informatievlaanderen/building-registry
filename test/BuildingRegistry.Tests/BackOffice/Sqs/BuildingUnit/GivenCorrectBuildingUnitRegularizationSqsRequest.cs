namespace BuildingRegistry.Tests.BackOffice.Sqs.BuildingUnit
{
    ...
    public sealed class GivenCorrectBuildingUnitRegularizationSqsRequest : BuildingRegistryTest
    {
        private readonly FakeBackOfficeContext _backOfficeContext;

        public GivenCorrectBuildingUnitRegularizationSqsRequest(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        ...
        public async Task ThenTicketWithLocationIsCreated()
        {
            ...
            var sut = new CorrectBuildingUnitRegularizationSqsHandler(
                sqsQueue.Object,
                ticketingMock.Object,
                ticketingUrl,
                _backOfficeContext);

            var sqsRequest = new CorrectBuildingUnitRegularizationSqsRequest
            {
                Request = new CorrectBuildingUnitRegularizationRequest
                {
