namespace BuildingRegistry.Tests.BackOffice.Sqs.BuildingUnit
{
    ...
    public sealed class GivenBackOfficeNotRealizeBuildingUnitRequest : BuildingRegistryTest
    {
        private readonly FakeBackOfficeContext _backOfficeContext;

        public GivenBackOfficeNotRealizeBuildingUnitRequest(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        ...
        public async Task ThenTicketWithLocationIsCreated()
        {
            ...
            var sut = new NotRealizeBuildingUnitSqsHandler(
                sqsQueue.Object,
            ...
            {
                Request = new BackOfficeNotRealizeBuildingUnitRequest
                {
