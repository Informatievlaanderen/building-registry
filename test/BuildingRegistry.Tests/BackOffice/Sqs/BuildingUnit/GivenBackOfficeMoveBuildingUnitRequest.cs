namespace BuildingRegistry.Tests.BackOffice.Sqs.BuildingUnit
{
    ...
    public sealed class GivenBackOfficeMoveBuildingUnitRequest : BuildingRegistryTest
    {
        private readonly FakeBackOfficeContext _backOfficeContext;

        public GivenBackOfficeMoveBuildingUnitRequest(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        ...
        public async Task ThenTicketWithLocationIsCreated()
        {
            ...
            var sut = new MoveBuildingUnitSqsHandler(
                sqsQueue.Object,
                ticketingMock.Object,
                ticketingUrl,
                _backOfficeContext);

            var sqsRequest = new MoveBuildingUnitSqsRequest
            {
