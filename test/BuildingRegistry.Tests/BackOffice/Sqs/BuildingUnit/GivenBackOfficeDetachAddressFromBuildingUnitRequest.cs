namespace BuildingRegistry.Tests.BackOffice.Sqs.BuildingUnit
{
    ...
    public sealed class GivenBackOfficeDetachAddressFromBuildingUnitRequest : BuildingRegistryTest
    {
        private readonly FakeBackOfficeContext _backOfficeContext;

        public GivenBackOfficeDetachAddressFromBuildingUnitRequest(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        ...
        public async Task ThenTicketWithLocationIsCreated()
        {
            ...
            var sqsRequest = new DetachAddressFromBuildingUnitSqsRequest()
            {
                BuildingUnitPersistentLocalId = Fixture.Create<BuildingUnitPersistentLocalId>(),
                Request = new DetachAddressFromBuildingUnitRequest()
            };
