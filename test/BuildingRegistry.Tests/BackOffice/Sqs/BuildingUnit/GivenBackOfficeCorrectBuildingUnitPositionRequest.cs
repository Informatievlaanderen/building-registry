namespace BuildingRegistry.Tests.BackOffice.Sqs.BuildingUnit
{
    ...
    public sealed class GivenBackOfficeCorrectBuildingUnitPositionRequest : BuildingRegistryTest
    {
        private readonly FakeBackOfficeContext _backOfficeContext;

        public GivenBackOfficeCorrectBuildingUnitPositionRequest(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
