namespace BuildingRegistry.Tests.BackOffice.Sqs.Building
{
    ...
    public sealed class GivenMergeBuildingSqsRequest : BuildingRegistryTest
    {
        public GivenMergeBuildingSqsRequest(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        ...
        public async Task ThenTicketWithLocationIsCreated()
        {
            ...
            var sut = new MergeBuildingSqsHandler(
                sqsQueue.Object,
                ticketingMock.Object,
                ticketingUrl);

            var sqsRequest = new MergeBuildingsSqsRequest
            {
