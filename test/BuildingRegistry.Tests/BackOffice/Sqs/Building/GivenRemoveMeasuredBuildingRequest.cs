namespace BuildingRegistry.Tests.BackOffice.Sqs.Building
{
    ...
    public sealed class GivenRemoveMeasuredBuildingRequest : BuildingRegistryTest
    {
        public GivenRemoveMeasuredBuildingRequest(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        ...
        public async Task ThenTicketWithLocationIsCreated()
        {
            ...
            var sut = new RemoveMeasuredBuildingSqsHandler(
                sqsQueue.Object,
                ticketingMock.Object,
                ticketingUrl);

            var sqsRequest = new RemoveMeasuredBuildingSqsRequest
            {
