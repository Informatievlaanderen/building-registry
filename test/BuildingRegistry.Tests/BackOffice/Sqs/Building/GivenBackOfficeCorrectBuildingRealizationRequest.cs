namespace BuildingRegistry.Tests.BackOffice.Sqs.Building
{
    ...
    public sealed class GivenBackOfficeCorrectBuildingRealizationRequest : BuildingRegistryTest
    {
        public GivenBackOfficeCorrectBuildingRealizationRequest(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        ...
        public async Task ThenTicketWithLocationIsCreated()
        {
            ...
            var sut = new CorrectBuildingRealizationSqsHandler(
                sqsQueue.Object,
                ticketingMock.Object,
                ticketingUrl);

            var sqsRequest = new CorrectBuildingRealizationSqsRequest
            {
                Request = new CorrectBuildingRealizationBackOfficeRequest
                {
