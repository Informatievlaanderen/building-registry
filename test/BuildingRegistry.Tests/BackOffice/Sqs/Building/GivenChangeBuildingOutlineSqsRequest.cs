namespace BuildingRegistry.Tests.BackOffice.Sqs.Building
{
    ...
    public sealed class GivenChangeBuildingOutlineSqsRequest : BuildingRegistryTest
    {
        public GivenChangeBuildingOutlineSqsRequest(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        ...
        public async Task ThenTicketWithLocationIsCreated()
        {
            ...
            var sut = new ChangeBuildingOutlineSqsHandler(
                sqsQueue.Object,
