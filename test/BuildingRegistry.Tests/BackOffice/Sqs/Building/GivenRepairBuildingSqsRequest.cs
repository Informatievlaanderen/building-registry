namespace BuildingRegistry.Tests.BackOffice.Sqs.Building
{
    ...
    public class GivenRepairBuildingSqsRequest : BuildingRegistryTest
    {
        public GivenRepairBuildingSqsRequest(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        ...
        public async Task ThenTicketWithLocationIsCreated()
        {
            ...
            var sut = new RepairBuildingSqsHandler(
                sqsQueue.Object,
                ticketingMock.Object,
                ticketingUrl);

            var sqsRequest = new RepairBuildingSqsRequest
            {
            ...
            sqsQueue.Verify(x => x.Copy(
                sqsRequest,
                It.Is<SqsQueueOptions>(y => y.MessageGroupId == sqsRequest.BuildingPersistentLocalId.ToString()),
