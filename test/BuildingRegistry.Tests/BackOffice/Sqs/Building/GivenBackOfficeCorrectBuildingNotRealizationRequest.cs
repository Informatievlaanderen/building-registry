namespace BuildingRegistry.Tests.BackOffice.Sqs.Building
{
    ...
    public sealed class GivenBackOfficeCorrectBuildingNotRealizationRequest : BuildingRegistryTest
    {
        public GivenBackOfficeCorrectBuildingNotRealizationRequest(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        ...
        public async Task ThenTicketWithLocationIsCreated()
        {
            ...
            var sut = new CorrectBuildingNotRealizationSqsHandler(
                sqsQueue.Object,
                ticketingMock.Object,
                ticketingUrl);

            var sqsRequest = new CorrectBuildingNotRealizationSqsRequest
            {
                Request = new BackOfficeCorrectBuildingNotRealizationRequest
                {
