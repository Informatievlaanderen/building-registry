namespace BuildingRegistry.Tests.BackOffice.Sqs.Building
{
    ...
    public sealed class GivenBackOfficePlaceBuildingUnderConstructionRequest : BuildingRegistryTest
    {
        public GivenBackOfficePlaceBuildingUnderConstructionRequest(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        ...
        public async Task ThenTicketWithLocationIsCreated()
        {
            ...
            var sut = new PlaceBuildingUnderConstructionSqsHandler(
                sqsQueue.Object,
            ...
            {
                Request = new BackOfficePlaceBuildingUnderConstructionRequest
                {
