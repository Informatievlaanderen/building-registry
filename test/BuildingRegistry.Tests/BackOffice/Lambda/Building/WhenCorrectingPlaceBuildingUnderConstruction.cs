namespace BuildingRegistry.Tests.BackOffice.Lambda.Building
{
    ...
    public class WhenCorrectingPlaceBuildingUnderConstruction : BackOfficeLambdaTest
    {
        ...
        public async Task ThenBuildingIsPlanned()
        {
            ...
            //Act
            await handler.Handle(CreateCorrectPlaceBuildingUnderConstructionLambdaRequest(), CancellationToken.None);
        ...
        private CorrectPlaceBuildingUnderConstructionLambdaRequest CreateCorrectPlaceBuildingUnderConstructionLambdaRequest()
        {
            var buildingPersistentLocalId = Fixture.Create<BuildingPersistentLocalId>();

            return new CorrectPlaceBuildingUnderConstructionLambdaRequest(buildingPersistentLocalId,
                new CorrectPlaceBuildingUnderConstructionSqsRequest()
                {
                    IfMatchHeaderValue = null,
                    Metadata = new Dictionary<string, object?>(),
                    ProvenanceData = Fixture.Create<ProvenanceData>(),
                    Request = new CorrectPlaceBuildingUnderConstructionRequest { PersistentLocalId = buildingPersistentLocalId },
