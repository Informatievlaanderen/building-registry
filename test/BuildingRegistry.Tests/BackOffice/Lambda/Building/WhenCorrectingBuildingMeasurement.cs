namespace BuildingRegistry.Tests.BackOffice.Lambda.Building
{
    ...
    public class WhenCorrectingBuildingMeasurement : BackOfficeLambdaTest
    {
        private readonly IdempotencyContext _idempotencyContext;

        public WhenCorrectingBuildingMeasurement(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        ...
        [Fact]
        public async Task ThenBuildingMeasurementIsCorrected()
        {
            // Arrange
            ...
            await handler.Handle(
                new CorrectBuildingMeasurementLambdaRequest(
                    buildingPersistentLocalId,
                    new CorrectBuildingMeasurementSqsRequest
                    {
        ...
        public async Task WhenIdempotencyException_ThenTicketingCompleteIsExpected()
        {
            ...
            //Act
            var request = new CorrectBuildingMeasurementLambdaRequest(
                buildingPersistentLocalId,
                new CorrectBuildingMeasurementSqsRequest
                {
                    BuildingPersistentLocalId = buildingPersistentLocalId,
        ...
        [Fact]
        public async Task WithInvalidGeometryMethod_ThenTicketingErrorIsExpected()
        {
            // Arrange
            var ticketing = new Mock<ITicketing>();
            ...
            ticketing.Verify(x =>
                x.Error(
                    ...
                    new TicketError(
                        ...
                        "GebouwGeplandInAanbouwGehistoreerdOfNietGerealiseerd"),
                    CancellationToken.None));
        }
    }
}
