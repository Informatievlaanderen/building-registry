namespace BuildingRegistry.Tests.BackOffice.Lambda.BuildingUnit
{
    ...
    public class WhenChangingBuildingUnitFunction : BackOfficeLambdaTest
    {
        private readonly IdempotencyContext _idempotencyContext;

        public WhenChangingBuildingUnitFunction(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        ...
        [Fact]
        public async Task ThenBuildingUnitFunctionIsChanged()
        {
            // Arrange
            ...
            PlanBuildingUnit(buildingPersistentLocalId, buildingUnitPersistentLocalId, function: BuildingUnitFunction.Lodging);

            var eTagResponse = new ETagResponse(string.Empty, Fixture.Create<string>());
            var handler = new ChangeBuildingUnitFunctionLambdaHandler(
            ...
            await handler.Handle(
                new ChangeBuildingUnitFunctionLambdaRequest(
                    ...
                    new ChangeBuildingUnitFunctionBackOfficeRequest
                    {
        ...
        public async Task WhenIdempotencyException_ThenTicketingCompleteIsExpected()
        {
            ...
            PlanBuilding(buildingPersistentLocalId);
            PlanBuildingUnit(buildingPersistentLocalId, buildingUnitPersistentLocalId, function: BuildingUnitFunction.Retail);
        ...
        public async Task WhenBuildingHasInvalidStatus_ThenTicketingErrorIsExpected()
        {
            ...
            await handler.Handle(
                new ChangeBuildingUnitFunctionLambdaRequest(
                    ...
                    new ChangeBuildingUnitFunctionBackOfficeRequest
                    {
                        Functie = GebouweenheidFunctie.LandTuinbouw
                    }),
                CancellationToken.None);
        ...
        public async Task WhenBuildingUnitHasInvalidStatus_ThenTicketingErrorIsExpected()
        {
            ...
            await handler.Handle(
                new ChangeBuildingUnitFunctionLambdaRequest(
                    ...
                    new ChangeBuildingUnitFunctionBackOfficeRequest
                    {
                        Functie = GebouweenheidFunctie.MilitaireFunctie
                    }),
                CancellationToken.None);
        ...
        public async Task WhenBuildingUnitHasInvalidFunction_ThenTicketingErrorIsExpected()
        {
            ...
            await handler.Handle(
                new ChangeBuildingUnitFunctionLambdaRequest(
                    ...
                    new ChangeBuildingUnitFunctionBackOfficeRequest
                    {
                        Functie = GebouweenheidFunctie.KantoorDienstverleningVrijBeroep
                    }),
                CancellationToken.None);
