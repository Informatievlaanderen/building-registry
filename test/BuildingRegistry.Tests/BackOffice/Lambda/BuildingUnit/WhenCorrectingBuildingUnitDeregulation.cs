namespace BuildingRegistry.Tests.BackOffice.Lambda.BuildingUnit
{
    ...
    public class WhenCorrectingBuildingUnitDeregulation : BackOfficeLambdaTest
    {
        private readonly IdempotencyContext _idempotencyContext;

        public WhenCorrectingBuildingUnitDeregulation(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
        ...
        [Fact]
        public async Task ThenBuildingUnitDeregulationIsCorrected()
        {
            // Arrange
            ...
            var handler = new CorrectBuildingUnitDeregulationLambdaHandler(
            ...
            //Act
            await handler.Handle(new CorrectBuildingUnitDeregulationLambdaRequest(
                buildingPersistentLocalId.ToString(),
                new CorrectBuildingUnitDeregulationSqsRequest
                {
                    TicketId = Guid.NewGuid(),
                    Request = new CorrectBuildingUnitDeregulationRequest { BuildingUnitPersistentLocalId = buildingUnitPersistentLocalId },
