namespace BuildingRegistry.Tests.BackOffice.Handlers.BuildingUnit
{
    ...
    public class GivenCorrectBuildingUnitRetirementRequest : BuildingRegistryTest
    {
        private readonly CorrectBuildingUnitRetirementHandler _sut;
        private readonly BackOfficeContext _backOfficeContext;

        public GivenCorrectBuildingUnitRetirementRequest(ITestOutputHelper outputHelper) : base(outputHelper)
        {
            _backOfficeContext = new FakeBackOfficeContextFactory().CreateDbContext();
            _sut = new CorrectBuildingUnitRetirementHandler(
        ...
        [Fact]
        public async Task GivenBuildingUnitRetired_ThenBuildingUnitIsCorrectedToRealization()
        {
