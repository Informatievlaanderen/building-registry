namespace BuildingRegistry.Tests.BackOffice.Handlers.BuildingUnit
{
    ...
    public class GivenAttachingAddressToBuildingUnitRequestRequest : BuildingRegistryTest
    {
        private readonly AttachAddressToBuildingUnitHandler _sut;
        private readonly BackOfficeContext _backOfficeContext;

        public GivenAttachingAddressToBuildingUnitRequestRequest(ITestOutputHelper outputHelper) : base(outputHelper)
        {
            _backOfficeContext = new FakeBackOfficeContextFactory().CreateDbContext();
            _sut = new AttachAddressToBuildingUnitHandler(
        ...
        [Fact]
        public async Task GivenAddressNotAttachedToBuildingUnit_ThenAddressIsAttachedToBuildingUnit()
        {
            ...
            var request = new AttachAddressToBuildingUnitRequest()
            {
