namespace BuildingRegistry.Tests.BackOffice.Handlers.BuildingUnit
{
    ...
    public class GivenRetireBuildingUnitRequest : BuildingRegistryTest
    {
        private readonly RetireBuildingUnitHandler _sut;
        private readonly BackOfficeContext _backOfficeContext;

        public GivenRetireBuildingUnitRequest(ITestOutputHelper outputHelper) : base(outputHelper)
        {
            _backOfficeContext = new FakeBackOfficeContextFactory().CreateDbContext();
            _sut = new RetireBuildingUnitHandler(
        ...
        [Fact]
        public async Task GivenBuildingUnitPlanned_ThenBuildingUnitRetired()
        {
