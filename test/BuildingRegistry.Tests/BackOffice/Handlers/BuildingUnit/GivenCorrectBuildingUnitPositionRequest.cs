namespace BuildingRegistry.Tests.BackOffice.Handlers.BuildingUnit
{
    ...
    public class GivenCorrectBuildingUnitPositionRequest : BuildingRegistryTest
    {
        private readonly CorrectBuildingUnitPositionHandler _sut;
        private readonly BackOfficeContext _backOfficeContext;

        public GivenCorrectBuildingUnitPositionRequest(ITestOutputHelper outputHelper) : base(outputHelper)
        {
            _backOfficeContext = new FakeBackOfficeContextFactory().CreateDbContext();
            _sut = new CorrectBuildingUnitPositionHandler(
        ...
        [Fact]
        public async Task GivenBuildingUnitPositionCorrected_ThenBuildingUnitPositionIsCorrected()
        {
