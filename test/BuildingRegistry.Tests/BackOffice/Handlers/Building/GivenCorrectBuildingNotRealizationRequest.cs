namespace BuildingRegistry.Tests.BackOffice.Handlers.Building
{
    ...
    public class GivenCorrectBuildingNotRealizationRequest : BuildingRegistryTest
    {
        private readonly CorrectBuildingNotRealizationHandler _sut;
        private readonly IBuildings _buildings;

        public GivenCorrectBuildingNotRealizationRequest(ITestOutputHelper testOutputHelper)
            : base(testOutputHelper)
        {
            ...
            _sut = new CorrectBuildingNotRealizationHandler(
        ...
        public async Task ThenPersistentLocalIdETagResponse()
        {
            ...
            var result = await _sut.Handle(
                new CorrectBuildingNotRealizationRequest { PersistentLocalId = Fixture.Create<BuildingPersistentLocalId>() },
