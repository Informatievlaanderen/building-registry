namespace BuildingRegistry.Tests.Legacy.Cases
{
    ...
    public class ChangeHouseNumberIdAfterSubaddressWasAdded : AutofacBasedTest
    {
        ...
        public ChangeHouseNumberIdAfterSubaddressWasAdded(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
            Fixture = new Fixture()
