            ...
            await Sut
                ...
                .Then(context =>
                {
                    ...
                    foreach (var buildingUnit in buildingWasMigrated.BuildingUnits)
                    {
                        ...
                        buildingUnitLatestItem.IdempotenceKey.Should().Be(position);
        ...
        public async Task WhenBuildingOutlineWasChanged()
        {
            ...
            await Sut
                ...
                .Then(async context =>
                {
                    ...
                    buildingUnitLatestItem.IdempotenceKey.Should().Be(position + 1);
                });
        }
        ...
        public async Task WhenBuildingUnitWasCorrectedFromRealizedToPlanned()
        {
            ...
            await Sut
                ...
                .Then(async context =>
                {
                    ...
                    buildingUnitLatestItem.IdempotenceKey.Should().Be(position + 2);
                });
        }
        ...
        public async Task WhenCommonBuildingUnitWasAddedV2()
        {
            ...
            await Sut
                ...
                .Then(async context =>
                {
                    ...
                    buildingUnitLatestItem.Function.Should()
