namespace BuildingRegistry.Tests.ProjectionTests.Integration
{
    ...
    public class BuildingUnitVersionProjectionsTests : IntegrationProjectionTest<BuildingUnitVersionProjections>
    {
                ...
                .Then(context =>
                {
                    ...
                    foreach (var buildingUnit in buildingWasMigrated.BuildingUnits)
                    {
                        ...
                        var buildingUnitAddresses = context.BuildingUnitAddresses
                            .Where(x => x.BuildingUnitPersistentLocalId == buildingUnitVersion.BuildingUnitPersistentLocalId)
                            .ToList();
        ...
        //         {
        //             var buildingUnitVersion =
        //                 await context.BuildingUnitVersions.FindAsync(buildingUnitWasPlannedV2.BuildingUnitPersistentLocalId);
        //             buildingUnitVersion.Should().NotBeNull();
        //
        //             buildingUnitVersion!.GeometryMethod.Should().Be(BuildingUnitPositionGeometryMethod.DerivedFromObject.Map());
        //             buildingUnitVersion.Geometry.Should()
        //                 .BeEquivalentTo(_wkbReader.Read(buildingMeasurementWasCorrected.ExtendedWkbGeometryBuildingUnits!.ToByteArray()));
        //             buildingUnitVersion.VersionTimestamp.Should().Be(buildingMeasurementWasCorrected.Provenance.Timestamp);
        //         });
        // }
        //
        // [Fact]
        ...
        //         .Then(async context =>
        //         {
        //             var buildingUnitVersion = await context.BuildingUnitVersions.FindAsync(buildingUnitWasPlannedV2
        ...
        //             buildingUnitVersion.VersionTimestamp.Should().Be(buildingMeasurementWasChanged.Provenance.Timestamp);
        //         });
        // }
        //
        // [Fact]
        ...
        //         .Then(async context =>
        //         {
        //             var buildingUnitVersion = await context.BuildingUnitVersions.FindAsync(buildingUnitWasPlannedV2.BuildingUnitPersistentLocalId);
        //             buildingUnitVersion.Should().NotBeNull();
        //
        ...
        //         {
        //             var buildingUnitVersion =
        //                 await context.BuildingUnitVersions.FindAsync(buildingUnitWasRealizedV2.BuildingUnitPersistentLocalId);
        //             buildingUnitVersion.Should().NotBeNull();
        //
        ...
        //         {
        //             var buildingUnitVersion =
        //                 await context.BuildingUnitVersions.FindAsync(buildingUnitWasRealized.BuildingUnitPersistentLocalId);
        //             buildingUnitVersion.Should().NotBeNull();
        //
        //             buildingUnitVersion!.Status.Should().Be(BuildingUnitStatus.Realized.Map());
        ...
        //         {
        //             var buildingUnitVersion =
        //                 await context.BuildingUnitVersions.FindAsync(buildingUnitWasCorrectedFromRealizedToPlanned.BuildingUnitPersistentLocalId);
        //             buildingUnitVersion.Should().NotBeNull();
        //
        //             buildingUnitVersion!.Status.Should().Be(BuildingUnitStatus.Planned.Map());
        ...
        //         {
        //             var buildingUnitVersion =
        //                 await context.BuildingUnitVersions.FindAsync(buildingUnitWasCorrectedToPlanned.BuildingUnitPersistentLocalId);
        //             buildingUnitVersion.Should().NotBeNull();
        //
        //             buildingUnitVersion!.Status.Should().Be(BuildingUnitStatus.Planned.Map());
        ...
        //         {
        //             var buildingUnitVersion =
        //                 await context.BuildingUnitVersions.FindAsync(buildingUnitWasNotRealizedV2.BuildingUnitPersistentLocalId);
        //             buildingUnitVersion.Should().NotBeNull();
        //
        ...
        //         {
        //             var buildingUnitVersion =
        //                 await context.BuildingUnitVersions.FindAsync(buildingUnitWasNotRealized.BuildingUnitPersistentLocalId);
        //             buildingUnitVersion.Should().NotBeNull();
        //
        //             buildingUnitVersion!.Status.Should().Be(BuildingUnitStatus.NotRealized.Map());
        ...
        //         {
        //             var buildingUnitVersion =
        //                 await context.BuildingUnitVersions.FindAsync(buildingUnitWasRetiredV2.BuildingUnitPersistentLocalId);
        //             buildingUnitVersion.Should().NotBeNull();
        //
        ...
        //         {
        //             var buildingUnitVersion =
        //                 await context.BuildingUnitVersions.FindAsync(buildingUnitWasCorrectedToRealized.BuildingUnitPersistentLocalId);
        //             buildingUnitVersion.Should().NotBeNull();
        //
        //             buildingUnitVersion!.Status.Should().Be(BuildingUnitStatus.Realized.Map());
        ...
        //         {
        //             var buildingUnitVersion =
        //                 await context.BuildingUnitVersions.FindAsync(buildingUnitPositionWasCorrected.BuildingUnitPersistentLocalId);
        //             buildingUnitVersion.Should().NotBeNull();
        //
        ...
        //         {
        //             var buildingUnitVersion =
        //                 await context.BuildingUnitVersions.FindAsync(buildingUnitWasRemovedV2.BuildingUnitPersistentLocalId);
        //             buildingUnitVersion.Should().NotBeNull();
        //
        ...
        //         {
        //             var buildingUnitVersion =
        //                 await context.BuildingUnitVersions.FindAsync(buildingUnitWasRemoved.BuildingUnitPersistentLocalId);
        //             buildingUnitVersion.Should().NotBeNull();
        //
        //             buildingUnitVersion!.IsRemoved.Should().BeTrue();
        ...
        //         {
        //             var buildingUnitVersion =
        //                 await context.BuildingUnitVersions.FindAsync(buildingUnitRemovalWasCorrected.BuildingUnitPersistentLocalId);
        //             buildingUnitVersion.Should().NotBeNull();
        //
        ...
        //         {
        //             var buildingUnitVersion =
        //                 await context.BuildingUnitVersions.FindAsync(buildingUnitWasRegularized.BuildingUnitPersistentLocalId);
        //             buildingUnitVersion.Should().NotBeNull();
        //
        //             buildingUnitVersion!.HasDeviation.Should().BeFalse();
        ...
        //         {
        //             var buildingUnitVersion =
        //                 await context.BuildingUnitVersions.FindAsync(buildingUnitRegularizationWasCorrected.BuildingUnitPersistentLocalId);
        //             buildingUnitVersion.Should().NotBeNull();
        //
        ...
        //         {
        //             var buildingUnitVersion =
        //                 await context.BuildingUnitVersions.FindAsync(buildingUnitWasDeregulated.BuildingUnitPersistentLocalId);
        //             buildingUnitVersion.Should().NotBeNull();
        //
        //             buildingUnitVersion!.HasDeviation.Should().BeTrue();
        ...
        //         {
        //             var buildingUnitVersion =
        //                 await context.BuildingUnitVersions.FindAsync(buildingUnitDeregulationWasCorrected.BuildingUnitPersistentLocalId);
        //             buildingUnitVersion.Should().NotBeNull();
        //
        //             buildingUnitVersion!.HasDeviation.Should().BeFalse();
        ...
        //         .Then(async context =>
        //         {
        //             var buildingUnitVersion = await context.BuildingUnitVersions.FindAsync(commonBuildingUnitWasAddedV2
        //                 .BuildingUnitPersistentLocalId);
        //             buildingUnitVersion.Should().NotBeNull();
        //
        ...
        //         {
        //             var buildingUnitVersion =
        //                 await context.BuildingUnitVersions.FindAsync(buildingUnitAddressWasAttachedV2.BuildingUnitPersistentLocalId);
        //             buildingUnitVersion.Should().NotBeNull();
        //
        ...
        //         {
        //             var buildingUnitVersion =
        //                 await context.BuildingUnitVersions.FindAsync(buildingUnitAddressWasDetachedV2.BuildingUnitPersistentLocalId);
        //             buildingUnitVersion.Should().NotBeNull();
        //
        ...
        //         {
        //             var buildingUnitVersion =
        //                 await context.BuildingUnitVersions.FindAsync(buildingUnitAddressWasDetached.BuildingUnitPersistentLocalId);
        //             buildingUnitVersion.Should().NotBeNull();
        //
        ...
        //         {
        //             var buildingUnitVersion =
        //                 await context.BuildingUnitVersions.FindAsync(buildingUnitAddressWasReplacedBecauseAddressWasReaddressed.BuildingUnitPersistentLocalId);
        //             buildingUnitVersion.Should().NotBeNull();
        //
        ...
        //         {
        //             var buildingUnitVersion =
        //                 await context.BuildingUnitVersions.FindAsync(buildingUnitWasRetired.BuildingUnitPersistentLocalId);
        //             buildingUnitVersion.Should().NotBeNull();
        //
        //             buildingUnitVersion!.Status.Should().Be(BuildingUnitStatus.Retired.Map());
        ...
        //         {
        //             var buildingUnitVersion =
        //                 await context.BuildingUnitVersions.FindAsync(buildingUnitWasTransferred.BuildingUnitPersistentLocalId);
        //             buildingUnitVersion.Should().NotBeNull();
        //
