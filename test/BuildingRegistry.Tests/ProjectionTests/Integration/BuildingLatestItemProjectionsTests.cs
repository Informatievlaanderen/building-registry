        ...
        public async Task WhenBuildingWasMigrated()
        {
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    ...
                    buildingLatestItem.IdempotenceKey.Should().Be(position);
                });
        }
        ...
        public async Task WhenBuildingUnitWasPlanned()
        {
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    ...
                    buildingLatestItem.IdempotenceKey.Should().Be(position + 1);
                });
        }
        ...
        public async Task WhenBuildingUnitWasRemovedV2()
        {
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    ...
                    buildingLatestItem.IdempotenceKey.Should().Be(position + 2);
                });
        }
        ...
        public async Task WhenBuildingUnitRemovalWasCorrected()
        {
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    ...
                    buildingLatestItem.IdempotenceKey.Should().Be(position + 3);
                });
        }
