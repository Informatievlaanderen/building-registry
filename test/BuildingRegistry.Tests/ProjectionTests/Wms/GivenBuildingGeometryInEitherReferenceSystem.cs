namespace BuildingRegistry.Tests.ProjectionTests.Wms
{
    ...
    public static class BuildingGeometryInEitherReferenceSystem
    {
        ...
        /// </summary>
        public static Geometry ReadAsStoredByTheComputedColumn(byte[] wkb, int computedColumnSrid)
        {
            var geometry = new WKBReader().Read(wkb);
            geometry.SRID = computedColumnSrid;
    ...
    /// </summary>
    public class GivenBuildingGeometryInEitherReferenceSystemV3 : BuildingWmsProjectionTest<BuildingV3Projections>
    {
        [Theory]
        ...
        public async Task ThenTheGeometryIsStoredInLambert72(int eventSrid, string eventPolygon)
        {
            await Sut
                ...
                .Then(async ct =>
                {
                    ...
                    var geometry = BuildingGeometryInEitherReferenceSystem.ReadAsStoredByTheComputedColumn(building!.Geometry!, SystemReferenceId.SridLambert72);
    ...
    /// </summary>
    public class GivenBuildingGeometryInEitherReferenceSystemV4 : BuildingWmsProjectionTest<BuildingV4Projections>
    {
        [Theory]
        [InlineData(SystemReferenceId.SridLambert72, BuildingGeometryInEitherReferenceSystem.Lambert72Polygon)]
        [InlineData(SystemReferenceId.SridLambert2008, BuildingGeometryInEitherReferenceSystem.Lambert2008Polygon)]
        public async Task ThenTheGeometryIsStoredInLambert2008(int eventSrid, string eventPolygon)
        {
            await Sut
                ...
                .Then(async ct =>
                {
                    ...
                    building.Should().NotBeNull();
                    var geometry = BuildingGeometryInEitherReferenceSystem.ReadAsStoredByTheComputedColumn(building!.Geometry!, SystemReferenceId.SridLambert2008);
