namespace BuildingRegistry.Tests.ProjectionTests.Wfs
{
    ...
    public class BuildingV3Tests : BuildingWfsProjectionTest<BuildingV3Projections>
    {
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    ...
                    buildingDetailItem.Status.Should()
                        .Be(BuildingV3Projections.MapStatus(BuildingStatus.Parse(buildingWasMigrated.BuildingStatus)));
                    ...
                    buildingDetailItem.GeometryMethod.Should()
                        .Be(BuildingV3Projections.MapGeometryMethod(BuildingGeometryMethod.Parse(buildingWasMigrated.GeometryMethod)));
                });
        }
        ...
        public async Task WhenBuildingWasPlannedV2()
        {
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    ...
                    buildingDetailItem.Status.Should().Be(BuildingV3Projections.MapStatus(BuildingStatus.Planned));
        ...
        public async Task WhenUnplannedBuildingWasRealizedAndMeasured()
        {
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    ...
                    buildingDetailItem.Status.Should().Be(BuildingV3Projections.MapStatus(BuildingStatus.Realized));
                    buildingDetailItem.GeometryMethod.Should().Be(BuildingV3Projections.MapGeometryMethod(BuildingGeometryMethod.MeasuredByGrb));
                    buildingDetailItem.IsRemoved.Should().BeFalse();
        ...
        public async Task WhenBuildingMeasurementWasChanged()
        {
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    ...
                    buildingDetailItem.GeometryMethod.Should().Be(BuildingV3Projections.MeasuredMethod);
        ...
        public async Task WhenBuildingBecameUnderConstructionV2()
        {
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    ...
                    buildingDetailItem.Status.Should().Be(BuildingV3Projections.MapStatus(BuildingStatus.UnderConstruction));
                });
        }
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    var buildingDetailItem =
                        await ct.BuildingsV3.FindAsync(buildingWasCorrectedFromUnderConstructionToPlanned.BuildingPersistentLocalId);
                    buildingDetailItem.Should().NotBeNull();
        ...
        public async Task WhenBuildingWasNotRealizedV2()
        {
            ...
            await Sut
                ...
                .Then(async ct =>
                {
                    ...
                    buildingDetailItem.Status.Should().Be(BuildingV3Projections.MapStatus(BuildingStatus.NotRealized));
                });
        }
