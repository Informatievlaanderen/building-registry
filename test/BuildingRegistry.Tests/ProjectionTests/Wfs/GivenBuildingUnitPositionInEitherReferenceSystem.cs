namespace BuildingRegistry.Tests.ProjectionTests.Wfs
{
    ...
    /// </summary>
    public class GivenBuildingUnitPositionInEitherReferenceSystemV2 : BuildingWfsProjectionTest<BuildingUnitV2Projections>
    {
        [Theory]
        ...
        public async Task ThenThePositionIsStoredInLambert72(int eventSrid, string eventPoint)
        {
            await Sut
                ...
                .Then(async ct =>
                {
                    ...
                    var position = (Point)unit!.Position;
    ...
    /// </summary>
    public class GivenBuildingUnitPositionInEitherReferenceSystemV3 : BuildingWfsProjectionTest<BuildingUnitV3Projections>
    {
        [Theory]
        [InlineData(SystemReferenceId.SridLambert72, BuildingUnitPositionInEitherReferenceSystem.Lambert72Point)]
        [InlineData(SystemReferenceId.SridLambert2008, BuildingUnitPositionInEitherReferenceSystem.Lambert2008Point)]
